...
LOGICAL, SAVE :: DetectCloud   = .FALSE.      ! flag for cloud retrieval
...
!!!fradea REAL,SAVE :: LwpSD = 0.2       ! Standard deviation for LWP retrieval; 
REAL,SAVE :: LwpSD = 0.05       ! Standard deviation for LWP retrieval; 
                               ! default 0.2

REAL,SAVE :: IWVSD = 2.50       ! Standard deviation for IWV retrieval; 
!fradea REAL,SAVE :: IWVSD = 0.05       ! Standard deviation for IWV retrieval; 
                               ! default 0.2
...
CHARACTER (LEN=80), SAVE :: Coeffs_Dir
