...
!   Supplies an unused fortran I/O unit number.
!
!   If a unit number cant be supplied then Gen_ErrorReport is called
!   with a warning.
!
! Method:
...
CHARACTER (LEN=*), PARAMETER :: RoutineName = "Gen_GetUnit"
